...
// var nextId = 0;
//
// function advise(dispatcher: IDispatcher, type: string, advice: Function, receiveArguments?: boolean): Handle {
...
// function noop(): void {}
//
// export function after(target: any, methodName: string, advice: Function): Handle {
...
// }
//
// export function before(target: any, methodName: string, advice: Function): Handle {
// 	return advise(getDispatcher(target, methodName), 'before', advice);
// }
//
// export function on(target: any, methodName: string, advice: Function): Handle {
...
export default function on(target: Object, methodName: string, advice: (...originalArgs: any[]) => any): Handle {
	console.log('advising ', target, methodName);
	return advise(getDispatcher(target, methodName), 'after', advice, true);
}
